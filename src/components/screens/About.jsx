			...
			<Grid container spacing={4} alignItems="center">
				...
				<Grid item xs={12} md={6}>
					...
					>
						...
						>
							Full-stack developer with 2+ years of experience in
							ReactJS, Django, and DevOps. Expertise in
							high-traffic website development, user engagement
							optimization, and RESTful API architecture. Mentored
							1000+ students in full-stack development.
						</Typography>
